        ...
        <div class="row justify-content-center text-center my-sm-5">
          <div class="col-lg-6">
            <MaterialBadge color="success" class="mb-3"
              >Übersicht unserer Leistungen</MaterialBadge
            >

            <h2 class="text-dark mb-0">Leistungen</h2>
            <p class="lead">
              Egal, ob Grundschule, Mittlere Reife, Gymnasium, Ausbildung oder Hochschule, in unserem Team gibt es eine passende Lehrkraft für dich.
            </p>
          </div>
        </div>
      </div>
